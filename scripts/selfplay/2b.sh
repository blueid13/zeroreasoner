...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/qwen35_2b_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/qwen35_2b_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/qwen35_2b_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    actor_rollout_ref.model.path=Qwen/Qwen3.5-2B-Base \
    ...
    trainer.experiment_name='azr_qwen35_2b' \
    ...
    azr.seed_dataset=data/qwen35_2b_seed_io.jsonl \
    azr.output_seed_path=data/qwen35_2b_seed_io.jsonl \
    azr.error_seed_dataset=data/qwen35_2b_error_seed_io.jsonl \
    azr.output_error_seed_path=data/qwen35_2b_error_seed_io.jsonl \
    azr.code_f_seed_dataset=data/qwen35_2b_code_f_seed_io.jsonl \
    azr.output_code_f_seed_path=data/qwen35_2b_code_f_seed_io.jsonl \
